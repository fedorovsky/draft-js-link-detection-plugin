...
var createLinkDetectionPlugin = function (options) {
    if (options === void 0) { options = {}; }
    var tlds = options.tlds, linkComponent = options.linkComponent;
    var linkify = (tlds === null || tlds === void 0 ? void 0 : tlds.length) ? linkify_it_1.default().tlds(tlds) : linkify_it_1.default();
    function isURL(text) {
    ...
    return {
        decorators: [
            {
                ...
                component: linkComponent !== null && linkComponent !== void 0 ? linkComponent : Link,
            },
        ],
        onChange: function (editorState) {
            ...
            var currentWordIsURL = isURL(currentWord);
